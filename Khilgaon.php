...
<body>
	...
	<br>
	<div class="wel"><h2>Welcome to Khilgaon</h2>
        <p>
    </div>
    <div id="sliderFrame">
        <div id="slider">
	...
	<!-- 	Append this section to change the images -->
            <a href="appeliano.php" target="_blank">  <!--This image is having a link on it.Use <a href="www.link.com" /a> -->
	...
	<div class="container big_logo">
		...
		<div class="row">
			...
			while($row = mysql_fetch_array($query)){
				...
				<div class="card">
					<img class="card-img-top" src="<?php echo $r_image; ?>">
					<div class="card-block">
						<a href="appeliano.php"><h4 class="card-title"><?php echo $r_name; ?></h4></a>
