			...
			<div class="col-md-6">
				...
				<div class="simple_form margin_top_50">
					...
					<?php
						if(isset($_POST['submit'])){
							...
							if(mysql_num_rows($query)){
                                    ...
                                    $query = mysql_query("DELETE FROM product where product.restaurant_name='$rname' AND product.product_name='$pname'");
									
									if($query){
										echo '<h2 align="center" style="color: green;">Congo!!!! Product Deleted Successfully</h2>'; 
										
										echo ("<script LANGUAGE='JavaScript'>
										window.alert('Congo!!!! Product Deleted Successfully');
                    ...
                    <input name="pid" required="required" class="form-control" placeholder="Product ID" type="integer">
						...
						<br> -->
						<input type="submit" name="submit" value="Delete" id="butt" class="btn btn-dark">
