		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="simple_form margin_top_50">
					...
					if (loggedin()) {
						if($UserLevel=='User') header ("location: search restaurant.php");
					...
					if (isset ($_POST['Signin'])) {
						...
						if ($UserName && $Password && $UserLevel) {
							$SignIn = mysql_query("SELECT * FROM user_account WHERE UserName='$UserName' and UserLevel='$UserLevel'");
					...
					<form method="post" action="">
						...
						<br>
						<label>Type</label>
					  	<input type="text"  name="Userlevel" placeholder="Enter Your type" class="form-control">
						<br>
